...
public class Monday extends Fragment {
    ...
    public void getData() {
        Subject1 = mSubjects.getString("monday1", "");
        Subject2 = mSubjects.getString("monday2", "");
        Subject3 = mSubjects.getString("monday3", "");
        Subject4 = mSubjects.getString("monday4", "");
        Subject5 = mSubjects.getString("monday5", "");
        Subject6 = mSubjects.getString("monday6", "");
        Subject7 = mSubjects.getString("monday7", "");
        Subject8 = mSubjects.getString("monday8", "");
    ...
    public void SaveData() {
        ...
        mEditor.putString("monday1", Subject1);
        mEditor.putString("monday2", Subject2);
        mEditor.putString("monday3", Subject3);
        mEditor.putString("monday4", Subject4);
        mEditor.putString("monday5", Subject5);
        mEditor.putString("monday6", Subject6);
        mEditor.putString("monday7", Subject7);
        mEditor.putString("monday8", Subject8);
        mEditor.apply();
    }
}