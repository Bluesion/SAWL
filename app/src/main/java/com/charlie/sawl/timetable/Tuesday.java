...
public class Tuesday extends Fragment {
    ...
    public void getData() {
        Subject1 = mSubjects.getString("tuesday1", "");
        Subject2 = mSubjects.getString("tuesday2", "");
        Subject3 = mSubjects.getString("tuesday3", "");
        Subject4 = mSubjects.getString("tuesday4", "");
        Subject5 = mSubjects.getString("tuesday5", "");
        Subject6 = mSubjects.getString("tuesday6", "");
        Subject7 = mSubjects.getString("tuesday7", "");
        Subject8 = mSubjects.getString("tuesday8", "");
    ...
    public void SaveData() {
        ...
        mEditor.putString("tuesday1", Subject1);
        mEditor.putString("tuesday2", Subject2);
        mEditor.putString("tuesday3", Subject3);
        mEditor.putString("tuesday4", Subject4);
        mEditor.putString("tuesday5", Subject5);
        mEditor.putString("tuesday6", Subject6);
        mEditor.putString("tuesday7", Subject7);
        mEditor.putString("tuesday8", Subject8);
        mEditor.apply();
    }
}