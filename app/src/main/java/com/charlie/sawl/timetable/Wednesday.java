...
public class Wednesday extends Fragment {
    ...
    public void getData() {
        Subject1 = mSubjects.getString("wednesday1", "");
        Subject2 = mSubjects.getString("wednesday2", "");
        Subject3 = mSubjects.getString("wednesday3", "");
        Subject4 = mSubjects.getString("wednesday4", "");
        Subject5 = mSubjects.getString("wednesday5", "");
        Subject6 = mSubjects.getString("wednesday6", "");
        Subject7 = mSubjects.getString("wednesday7", "");
        Subject8 = mSubjects.getString("wednesday8", "");
    ...
    public void SaveData() {
        ...
        mEditor.putString("wednesday1", Subject1);
        mEditor.putString("wednesday2", Subject2);
        mEditor.putString("wednesday3", Subject3);
        mEditor.putString("wednesday4", Subject4);
        mEditor.putString("wednesday5", Subject5);
        mEditor.putString("wednesday6", Subject6);
        mEditor.putString("wednesday7", Subject7);
        mEditor.putString("wednesday8", Subject8);
        mEditor.apply();
    }
}