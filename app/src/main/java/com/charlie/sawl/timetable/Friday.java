...
public class Friday extends Fragment {
    ...
    public void getData() {
        Subject1 = mSubjects.getString("friday1", "");
        Subject2 = mSubjects.getString("friday2", "");
        Subject3 = mSubjects.getString("friday3", "");
        Subject4 = mSubjects.getString("friday4", "");
        Subject5 = mSubjects.getString("friday5", "");
        Subject6 = mSubjects.getString("friday6", "");
        Subject7 = mSubjects.getString("friday7", "");
        Subject8 = mSubjects.getString("friday8", "");
    ...
    public void SaveData() {
        ...
        mEditor.putString("friday1", Subject1);
        mEditor.putString("friday2", Subject2);
        mEditor.putString("friday3", Subject3);
        mEditor.putString("friday4", Subject4);
        mEditor.putString("friday5", Subject5);
        mEditor.putString("friday6", Subject6);
        mEditor.putString("friday7", Subject7);
        mEditor.putString("friday8", Subject8);
        mEditor.apply();
    }
}