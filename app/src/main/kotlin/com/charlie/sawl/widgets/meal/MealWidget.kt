...
class MealWidget : AppWidgetProvider() {
    ...
    override fun onUpdate(context: Context, appWidgetManager: AppWidgetManager, appWidgetIds: IntArray) {
        for (appWidgetId in appWidgetIds) {
            val svcIntent = Intent(context, MealWidgetService::class.java)

            val widget = RemoteViews(context.packageName, R.layout.widget_meal)
            ...
            clickIntent = Intent(context, MealWidget::class.java)
    ...
    companion object {
        ...
        fun updateWidget(context: Context) {
            ...
            val appWidgetIds = appWidgetManager.getAppWidgetIds(ComponentName(context, MealWidget::class.java))
